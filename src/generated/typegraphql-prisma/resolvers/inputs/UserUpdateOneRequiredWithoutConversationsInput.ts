...
import { UserUpsertWithoutConversationsInput } from "../inputs/UserUpsertWithoutConversationsInput";
import { UserWhereUniqueInput } from "../inputs/UserWhereUniqueInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class UserUpdateOneRequiredWithoutConversationsInput {
  ...
  @TypeGraphQL.Field(_type => UserUpsertWithoutConversationsInput, {
    nullable: true
  })
  upsert?: UserUpsertWithoutConversationsInput | undefined;
  ...
  update?: UserUpdateWithoutConversationsInput | undefined;
}
