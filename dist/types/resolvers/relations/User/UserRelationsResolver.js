...
const UserFriendsArgs_1 = require("./args/UserFriendsArgs");
const UserFriendsRelationArgs_1 = require("./args/UserFriendsRelationArgs");
...
let UserRelationsResolver = class UserRelationsResolver {
    ...
    friendsRelation(user, ctx, args) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, helpers_1.getPrismaFromContext)(ctx).user.findUnique({
                where: {
                    id: user.id,
                },
            }).friendsRelation(args);
        });
    }
};
__decorate([
...
__decorate([
    ...
    __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [User_1.User, Object, UserFriendsArgs_1.UserFriendsArgs]),
    __metadata("design:returntype", Promise)
], UserRelationsResolver.prototype, "friends", null);
__decorate([
    TypeGraphQL.FieldResolver(_type => [User_1.User], {
        nullable: false
    }),
    ...
    __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [User_1.User, Object, UserFriendsRelationArgs_1.UserFriendsRelationArgs]),
    __metadata("design:returntype", Promise)
], UserRelationsResolver.prototype, "friendsRelation", null);
